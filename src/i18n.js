...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'hero.headline.line1': 'Turn your security cameras into',
      'hero.headline.into': '',
      'hero.headline.dimensioners': 'warehouse intelligence',
      'hero.scroll': 'Scroll',
      ...
      'install.headline.line1': 'No new hardware or processes',
      'install.headline.line2': '',
      'install.headline.line3': '',
      'install.step1.title': 'In-motion dimensions',
      'install.step1.desc': 'Every handling unit measured as it moves through the dock — no station, no waiting.',
      'install.step1.cta': 'Learn more',
      'install.step1.anchor': '#comparison',
      'install.step2.title': 'Shipment localization',
      'install.step2.desc': 'Know where each shipment sits so nothing gets lost, in real time.',
      'install.step2.cta': 'Learn more',
      'install.step2.anchor': '#tracking-lookup',
      'install.step3.title': 'Load verification',
      'install.step3.desc': 'Confirm that inbound and outbound loads match the manifest before they roll out.',
      'install.step3.cta': 'Learn more',
      'install.step3.anchor': '#tracking-lookup',

      'tracking.headline.prefix': 'Find and track any shipment',
      'tracking.headline.accent': 'on the dock.',
      'tracking.count_template': '{n} Handling units tracked',
      ...
      'faq.q2.q': 'How do you identify the scanned handling unit?',
      'faq.q2.a': 'Our proprietary AI is triggered by the timestamp per scan event. Around that second, our AI analyzes human motion, gaze and pose to identify which item was scanned.',
      'faq.q3.q': 'How long does setup take?',
      'faq.q3.a': 'A typical rollout takes one day to set up a pilot zone. Because it is software-only, we connect to your WMS or TMS, calibrate the camera positions, and you are live.',
    ...
    de: {
      ...
      'install.step1.desc': 'transload l\u00e4uft auf den Standard-IP-Kameras, die Sie bereits betreiben \u2014 Axis, Hikvision, Bosch, Dahua, Hanwha und die meisten anderen.',
      'install.step2.title': 'Keine Prozess\u00e4nderungen',
      'install.step2.desc': 'Fahrer und Staplerfahrer m\u00fcssen nichts \u00e4ndern. Keine neue Hardware, keine neuen Abl\u00e4ufe.',
      'install.step3.title': 'Live in Tagen, nicht Wochen',
      'install.step3.desc': 'Ein typischer Rollout dauert einen Tag, um eine Pilotzone einzurichten. Wir verbinden uns mit Ihrem WMS oder TMS, kalibrieren die Kamerapositionen und Sie sind live.',

      'tracking.headline.prefix': 'Verfolgen Sie jede Sendung',
      'tracking.headline.accent': 'auf der Halle.',
      'tracking.count_template': '{n} Packst\u00fccke erkannt',
      'tracking.select': 'Packst\u00fcck ausw\u00e4hlen',
      'tracking.carrier': 'Versender',
      ...
      'faq.q2.q': 'Wie identifizieren Sie das gescannte Packstück?',
      'faq.q2.a': 'Unsere proprietäre KI wird durch den Zeitstempel je Scan-Ereignis ausgelöst. In dieser Sekunde analysiert sie menschliche Bewegung, Blickrichtung und Körperhaltung, um zu erkennen, welches Packstück gescannt wurde.',
      'faq.q3.q': 'Wie lange dauert die Inbetriebnahme?',
      'faq.q3.a': 'Ein typischer Rollout dauert einen Tag, um eine Testzone aufzusetzen. Da es sich um eine reine Softwarelösung handelt, binden wir Ihr WMS oder TMS an, kalibrieren die Kamerapositionen und Sie sind startklar.',
      ...
      'faq.q6.q': 'Müssen Staplerfahrer ihren Ablauf ändern?',
