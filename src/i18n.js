...
(function () {
  ...
  const STRINGS = {
    ...
    de: {
      ...
      'hero.yc.backed_by': 'Finanziert von',
      'hero.yc.combinator': 'Combinator',
      'hero.headline.line1': 'Verwandeln Sie Ihre \u00dcberwachungskameras',
      ...
      'install.headline.line2': 'Keine neuen Arbeitsabl\u00e4ufe.',
      'install.headline.line3': 'Nur Ihre bestehenden Kameras.',
      'install.step1.title': 'Funktioniert mit Ihren bestehenden Kameras',
      ...
      'install.step2.body': 'Keine Workflow-\u00c4nderungen f\u00fcr Ihr Team. Keine neue Hardware. Optimiert auf Geschwindigkeit.',
      ...
      'install.footnote': 'Kennzeichen werden mit Abmessungen und Scan-Zeitstempel verkn\u00fcpft.',
      ...
      'comparison.now.row2': 'Messung \u00fcberall auf dem Terminal',
      'comparison.now.row3': 'L\u00e4uft vollst\u00e4ndig im Hintergrund \u2014 keine zus\u00e4tzlichen Schritte',

      'book.eyebrow': 'Demo buchen',
      'book.headline': 'Erfahren Sie, was transload f\u00fcr Sie tun kann.',
    },
  };
