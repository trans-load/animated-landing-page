...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'faq.q2.a': 'transload measures pallets and parcels with accuracy comparable to legacy dimensioner stations, and it covers every shipment in the loading hall — not just samples.',
    ...
    de: {
      ...
      'faq.q2.a': 'transload misst Paletten und Packstücke mit einer Genauigkeit, die klassischen Messstationen entspricht — und erfasst dabei jede Sendung in der Umschlaghalle, nicht nur Stichproben.',
